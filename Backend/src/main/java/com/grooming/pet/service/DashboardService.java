...
public class DashboardService {
    ...
    public AppointmentDetailResponse getAppointmentDetail(Long bookingId) {
        ...
        String  reviewComment = review != null ? review.getComment() : null;
        LocalDateTime reviewedAt = review != null ? review.getCreatedAt() : null;
        ...
        return new AppointmentDetailResponse(
                ...
                booking.getMeetingInfo(),
                hasReview, reviewRating, reviewComment, reviewedAt);
    }
